...
public class Voxels { // TODO: add more blocks, theres just eleven out of like a thousand
    ...
    public static readonly Voxel STRIPPED_OAK_LOG = register("stripped_oak_log", log(MaterialColor.WOOD, MaterialColor.WOOD));
    ...
    */
    ...
    private static Voxel register(string id, Voxel v) {
        return VoxelRegistry.register($"minecraft:{id}", v);
    }
}